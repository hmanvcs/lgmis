...
/*
********************************************************************************
Zend_View instance for Zend integration 
********************************************************************************
*/
var $view; 
/*
...
********************************************************************************
*/
function showMonth($showNoMonthDays=true){
...
function mkUrl($year,$month=false,$day=false){
	$params = array(); 
	if ($year) {
		$params[$this->yearID] = $year; 
	}
	if ($month !== false) {
		$params[$this->monthID] = $month; 
	}
	// use the current day if none is provided 
	if ($day === false) {
		$params[$this->dayID] = date("j"); 
	} else {
		$params[$this->dayID] = $day; 
	}
	return '<a href="'.$this->view->url($params).'">';
}
/*
********************************************************************************
...
function mkWeekNum($var){
	$params = array($this->yearID => $this->actyear, $this->weekID => $this->getWeekNum($var)); 
	$year=$this->actyear;
	...
	if ($this->weekUrl){
		...
		$out.='<a href=\""'.$this->view->url($params).'">'.$week.'</a>';
	}
