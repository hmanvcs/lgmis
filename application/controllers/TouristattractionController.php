<?php
class TouristattractionController extends SecureController {
/* (non-PHPdoc)
	...
	function createAction() {
		...
		if($this->_getParam('hasimage') == '1'){
			...
			// base path for uploaded 
		 	$destination_path = APPLICATION_PATH.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.PUBLICFOLDER.DIRECTORY_SEPARATOR.'uploads'.DIRECTORY_SEPARATOR.'tourism'.DIRECTORY_SEPARATOR;
			...
			if($upload->receive()){
				...
				resizeImage($thefilename, $thefilename, 300);
