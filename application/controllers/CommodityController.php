...
class CommodityController extends SecureController {
	...
	function getResourceForACL() {
		return isLGMISAdmin() ? "Location Statistic" : "Commodity"; 
	}
	...
	function createAction() {
		...
		if($this->_getParam('hasimage') == '1'){
			...
			// base path for uploaded 
		 	$destination_path = APPLICATION_PATH.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'public'.DIRECTORY_SEPARATOR.'uploads'.DIRECTORY_SEPARATOR.'commodity'.DIRECTORY_SEPARATOR;
